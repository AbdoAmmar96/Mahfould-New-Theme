                    ...
                    <div className="mk-detail">
                        ...
                        <div>
                            <div className="mk-book">
                                ...
                                <label className="mk-field"><span className="mk-label">التاريخ</span><input className="mk-input" type="date" /></label>
                                <label className="mk-field"><span className="mk-label">الوقت</span>
                                    <select className="mk-select"><option>7:00 مساءً</option><option>8:00 مساءً</option><option>9:00 مساءً</option></select></label>
                                ...
                                <Link href={restaurant.checkout_url} className="mk-btn mk-btn-primary mk-btn-block mk-btn-lg" style={{ marginTop: 14 }}>احجز الترابيزة</Link>
                            </div>
                        </div>
                    </div>
                </div>
